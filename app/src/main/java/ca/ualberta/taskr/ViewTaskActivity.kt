...
class ViewTaskActivity: AppCompatActivity(), EditBidFragment.EditBidFragmentInteractionListener,
     ...
     * Task to be displayed is obtained as a serialized [Task] object generated by [GenerateRetrofit].
     ...
     * display user profile images. [User] objects are obtained using [GenerateRetrofit].
     *
     * @see [BidListAdapter]
     * @see [AcceptBidFragment]
     * @see [EditBidFragment]
     ...
     * in the activity. The [User] object containing that information is obtained and serialized
     * using [GenerateRetrofit]
     *
     ...
     * task has no bids (i.e. status is REQUESTED). To pass the task to this activity, it must
     * be serialized via [GenerateRetrofit].
     ...
     * modified task is returned and deserialized using [GenerateRetrofit].
     *
     * @param requestCode
     * @param resultCode
